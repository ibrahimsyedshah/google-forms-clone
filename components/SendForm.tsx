      ...
      <DialogContent className="p-0">
        ...
        <div>
          <Tabs defaultValue="link" className="p-0">
            <TabsList
              className="w-full gap-x-5 px-4 pt-2 pb-0 bg-transparent h-full border-b flex 
              ...
              <div className="flex items-center gap-x-3">
                ...
                {tabs.map((tab) => (
                  <TabsTrigger
                    key={tab.value}
                    value={tab.value}
                    className="flex-col !p-0 group after:content-[''] after:h-[3px] data-[state=active]:text-violet-900 text-neutral-950 
                        data-[state=active]:after:bg-violet-900 after:w-full after:mt-2 after:rounded-t-full"
                    asChild
                  >
