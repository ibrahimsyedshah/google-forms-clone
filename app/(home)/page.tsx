        ...
        <>
          <div className="w-full py-12 md:py-24 lg:py-32">
            <div className="container px-4 md:px-6 ">
              <div className="flex flex-col items-center items-center space-y-4 text-center">
          ...
          <section className="w-full py-12 md:py-24 lg:py-32">
            <div className="container grid item-center gap-4 px-4 md:px-6 lg:gap-10">
              <div className="space-y-3">
                ...
                <p className="max-w-[700px] text-gray-500 md:text-xl/relaxed">
                  ...
                  collect and organise information quickly and efficiently.
                </p>
              </div>
